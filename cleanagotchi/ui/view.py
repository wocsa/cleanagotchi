...
from cleanagotchi.voice import Voice

import cleanagotchi.ui.fonts as fonts
import cleanagotchi.ui.faces as faces
from cleanagotchi.ui.components import *
from cleanagotchi.ui.state import State
...
class View(object):
    def __init__(self, config, impl, state=None):
        ...
        self._state = State(state={
            ...
            'name': Text(value='%s>' % 'cleanagotchi', position=self._layout['name'], color=BLACK, font=fonts.Bold),
