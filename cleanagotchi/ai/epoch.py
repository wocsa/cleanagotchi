...
import cleanagotchi.mesh.wifi as wifi

from cleanagotchi.ai.reward import RewardFunction
...
class Epoch(object):
    ...
    def next(self):
        ...
        now = time.time()
        cpu = cleanagotchi.cpu_load()
        mem = cleanagotchi.mem_usage()
        temp = cleanagotchi.temperature()
